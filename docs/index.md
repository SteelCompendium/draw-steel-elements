...
The [Roll Element](Roll.md) is a standalone Draw Steel dice roller (power rolls, tests, opposed rolls, flat dice). Rolling can also be enabled on rendered ability cards via the plugin's **Rolling** settings.
