...
//
// Named collapsible2 because kit/collapsible.ts (the D1 CollapsibleHeading port) still
// owns the `collapsible` name; Plan 09 renames this once the old widget is deleted.
//
...
export interface Collapsible2Handle {
