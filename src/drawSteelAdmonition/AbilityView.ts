...
export class AbilityView {
    ...
    public build(parent: HTMLElement) {
        if (this.data.indent) {
            parent.addClass("indent-" + this.data.indent);
        }

        const typeContainer = parent.createEl("div", {cls: "pr-name-line"});
        if (this.data.name) {
        ...
        if (this.data.flavor) {
            const flavorContainer = parent.createEl("div", {cls: "pr-detail-line pr-flavor-line"});
        ...
        if (this.data.keywords || this.data.type) {
            const row1 = parent.createEl("div", {cls: "pr-detail-table-row"});
        ...
        if (this.data.distance || this.data.target) {
            const row2 = parent.createEl("div", {cls: "pr-detail-table-row"});
        ...
        if (this.data.trigger) {
            const triggerContainer = parent.createEl("div", {cls: "pr-detail-line pr-trigger-line"});
        ...
        if (this.data.roll) {
            const typeContainer = parent.createEl("div", {cls: "pr-detail-line pr-roll-line"});
            this.renderMD(this.ctx, this.data.roll, typeContainer.createEl("span", {cls: "pr-roll-value ds-multiline"}));
        }

        if (this.data.t1) {
            const t1Container = parent.createEl("div", {cls: "pr-detail-line pr-tier-line pr-tier-1-line"});
        ...
        if (this.data.t2) {
            const t2Container = parent.createEl("div", {cls: "pr-detail-line pr-tier-line pr-tier-2-line"});
        ...
        if (this.data.t3) {
            const t3Container = parent.createEl("div", {cls: "pr-detail-line pr-tier-line pr-tier-3-line"});
        ...
        if (this.data.crit) {
            const critContainer = parent.createEl("div", {cls: "pr-detail-line pr-tier-line pr-crit-line"});
        ...
        if (this.data.effect) {
            const effectContainer = parent.createEl("div", {cls: "pr-detail-line pr-effect-line"});
        ...
        if (this.data.fields && this.data.fields.length > 0) {
            const fieldsContainer = parent.createEl("div", {cls: "pr-fields-container"});
        ...
        if (this.data.spend) {
            const spendLine = parent.createEl("div", {cls: "pr-detail-line pr-spend-line"});
        ...
        if (this.data.persistent) {
            const persistentLine = parent.createEl("div", {cls: "pr-detail-line pr-persistent-line"});
        ...
        if (this.data.notes) {
            if (Array.isArray(this.data.notes)) {
                const notesContainer = parent.createEl("ul", {cls: "pr-note-list"});
                this.data.notes.forEach(note => this.renderMD(this.ctx, note, notesContainer.createEl("li", {cls: "pr-note-item"})));
            } else {
                const noteContainer = parent.createEl("div", {cls: "pr-detail-line pr-note-line"});
    ...
    private renderMD(ctx: MarkdownPostProcessorContext, markdown: string, el: HTMLElement) {
        ...
        MarkdownRenderer.render(this.plugin.app, markdown.trim(), el, ctx.sourcePath, this.plugin as Component);
    }
