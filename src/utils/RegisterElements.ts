...
import { FeatureProcessor as FeatureProcessorOld } from "@drawSteelAdmonition/Features/FeatureProcessor";
...
export function registerElements(plugin: Plugin) {
    const FeatureProcessor = new genericComponentProcessor(
        plugin,
        FeatureBlock,
        FeatureModel,
        "Feature Block",
    ...
    const hrProcessor = new genericComponentProcessor(
        plugin,
        HorizontalRule,
        undefined,
        "Horizontal Rule",
    ...
    const initProcessor = new InitiativeProcessor(
        plugin as DrawSteelAdmonitionPlugin,
    );
    ...
    let staminaBarProcessor = new genericComponentProcessor(
        plugin,
        StaminaBar,
        StaminaBarModel,
        "Stamina Bar",
    ...
    let counterProcessor = new genericComponentProcessor(
        plugin,
        Counter,
        CounterModel,
        "Counter",
    ...
    let skillListProcessor = new genericComponentProcessor(
        plugin,
        SkillList,
        SkillsModel,
        "Skill List",
    ...
    let glyphProcessor = new genericComponentProcessor(
        plugin,
        DsGlyph,
        DsGlyphModel,
        "Glyph",
